...
INSERT INTO `servició` (`id_servició`, `id_vehículo`, `fecha`, `detalle`, `costo_total`) VALUES
(501, 301, '2025-06-01', 'cambio de aceite y filtros, diagnostico de motor', 120.00),
(502, 302, '2025-05-30', 'reparación de la suspensión ', 250.50),
(503, 303, '2025-05-28', 'revisión del sistema de frenos ', 80.00),
(504, 304, '2025-05-25', 'solución de avería eléctrica ', 180.00);
...
ALTER TABLE `servició`
  ADD PRIMARY KEY (`id_vehículo`,`id_servició`) USING BTREE,
  ADD KEY `servició_ibfk_3` (`id_servició`);
...
--
ALTER TABLE `servició`
  ADD CONSTRAINT `servició_ibfk_1` FOREIGN KEY (`id_vehículo`) REFERENCES `vehículo` (`id_vehículo`),
  ADD CONSTRAINT `servició_ibfk_2` FOREIGN KEY (`id_servició`) REFERENCES `servició_repuesta` (`id_servició`),
  ADD CONSTRAINT `servició_ibfk_3` FOREIGN KEY (`id_servició`) REFERENCES `servició_mecánico` (`id_servició`);
